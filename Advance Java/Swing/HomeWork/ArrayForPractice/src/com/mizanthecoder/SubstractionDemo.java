 ...
 * @author mohdm
 */
public class SubstractionDemo extends javax.swing.JFrame {

    /**
     * Creates new form CalDemo
     */
    public SubstractionDemo() {
        initComponents();
    }
...
//        }
        ...
        new SubTotalDemo(total).setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubstractionDemo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
