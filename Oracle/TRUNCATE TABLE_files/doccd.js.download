...
var linkcategories = {
    rank_advanced      : "http://www.oracle.com/pls/db111/ranked?advanced=1",
    homepage           : "../../index.htm",
    ...
    acronym_list       : "../../nav/acronym_list.htm",
...
function addThisDocument() {
    var heading, a, li1, ul, thisDocument,
      ...
      nav_cookie_name = "ORA_" + "B28359_01" + "_NAV", error404 = 0,
  ...
  function addSubCategories() {
    ...
    link(l10n.acronyms, linkcategories.acronym_list);
