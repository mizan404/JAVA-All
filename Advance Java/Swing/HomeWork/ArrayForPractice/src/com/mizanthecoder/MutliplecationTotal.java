 ...
 * @author mohdm
 */
public class MutliplecationTotal extends javax.swing.JFrame {

    /**
     * Creates new form CalDemo
     */
    public MutliplecationTotal() {
        initComponents();
    }
    int total1;

    MutliplecationTotal(int total) {
        initComponents();
        this.total1 = total;
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MutliplecationTotal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MutliplecationTotal().setVisible(true);
            }
        });
    }
